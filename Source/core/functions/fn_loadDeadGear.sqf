...
removeAllWeapons player; //Another attempt at removing the MX from revived players
{
...
//if(_primary != "") then {[_primary,true,false,false,false] spawn life_fnc_handleItem;}; - possable fix to the MXC Spawning on revived players
