...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["skins\offroad_01_ext_base05_co.paa","cop"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["skins\medic_hum.paa","med"]
		];
	};
	case "CUP_B_Dingo_CZ_Wdl":
	{
		_ret =
		[
			["skins\ACR_karosse_des_co.paa","cop"]
		];
	};
	case "B_Heli_Light_01_stripped_F":
	{
		_ret =
		[
			["skins\heli_light_01_ext_blufor_co.paa","cop"]
		];
	};
	case "CUP_I_SUV_Armored_ION":
	{
		_ret =
		[
			["skins\suv_armored_body_co.paa","cop"]
		];
	};
	case "CUP_C_SUV_CIV":
	{
		_ret =
		[
			["skins\suv_01_ext_02_co.paa","cop"]
		];
	};
