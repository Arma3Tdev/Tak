...
*/
	...
	player createDiaryRecord["TaskForceRadio",
		[
			"TaskForce Controls",
				"
					Push-to-talk button in TeamSpeak	Direct Speech.<br/>
					CTRL + TAB  To Switch From Whisper Normal Yelling.<br/>
					Caps Lock	To talk on a radio.<br/>
					CTRL + Caps Lock To talk on a long range radio.<br/>
					CTRL + P	To open the personal radio interface (the radio must be in the inventory slot).<br/>
					CTRL + + [/]	Cycle through available shortwave radios.<br/>
					ALT + P	To open a long range radio interface (a long range radio must be put on your back, or you should be in a vehicle in a position of a driver.<br/>
					CTRL + ALT + [/]	Cycle through available long range radios.<br/><br/>
				"
		]
	];
		...
		[
			"Communication Rules", 
				"
			    	...
			    	1. TFR may not be used to play music or otherwise micspam.<br/>
