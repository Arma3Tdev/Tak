                ...
                ["TPF Equipment",
                    [
                        ...
                        ["NVGoggles",nil,2000 * _discount],
            						...
            						["TRYK_ESS_BLKBLK_NV",nil,10000 * _discount],
            ...
            default
            {
                ["Mohammed's Jihadi Shop",
                    [
                        ...
                        ["CUP_srifle_M24_des",nil,200000 * _discount],
                        ["CUP_5Rnd_762x51_M24",nil,2500 * _discount],
                        ["CUP_srifle_AWM_des",nil,200000 * _discount],
                        ["CUP_5Rnd_86x70_L115A1",nil,2500 * _discount],
                        ["CUP_srifle_CZ550",nil,100000 * _discount],
                ...
                ["Mohammed's Jihadi Shop",
                    [
                        ...
                        ["CUP_20Rnd_762x51_B_M110",nil,3000 * _discount],
            						["srifle_EBR_F",nil,200000 * _discount],
            						["20Rnd_762x51_Mag",nil,4000 * _discount],
            						["srifle_DMR_01_F",nil,100000 * _discount],
            						["10Rnd_762x54_Mag",nil,100000 * _discount],
            						["CUP_arifle_M16A2",nil,100000 * _discount],
            						["CUP_arifle_M4A1",nil,100000 * _discount],
            						["CUP_arifle_Mk16_CQC",nil,100000 * _discount],
            						["30Rnd_556x45_Stanag_Tracer_Green",nil,3000 * _discount],
            						["CUP_acc_ANPEQ_2",nil,20000 * _discount],
            						["CUP_optic_ACOG",nil,20000 * _discount],
            						["CUP_optic_CompM2_Black",nil,20000 * _discount],
            						["CUP_optic_RCO",nil,20000 * _discount],
            						["CUP_acc_ANPEQ_2",nil,20000 * _discount],
            						["CUP_optic_MRad",nil,20000 * _discount],
            						["CUP_optic_TrijiconRx01_black",nil,20000 * _discount],
            						["CUP_muzzle_snds_M16",nil,25000 * _discount],
            						["CUP_srifle_AS50",nil,1000000 * _discount],
            						["CUP_5Rnd_127x99_as50_M",nil,25000 * _discount],
                        ...
                        ["CUP_50Rnd_UK59_762x54R_Tracer",nil,5000 * _discount],
            						["MMG_02_black_F",nil,500000 * _discount],
            						["130Rnd_338_Mag",nil,5000 * _discount],
            						["HandGrenade",nil,20000 * _discount],
            						["SmokeShell",nil,5000 * _discount],
                        ["SatchelCharge_Remote_Mag",nil,100000 * _discount],
            						["IEDLandSmall_Remote_Mag",nil,100000 * _discount],
            						["IEDUrbanSmall_Remote_Mag",nil,100000 * _discount]
                    ]
                ];
            };
        };
